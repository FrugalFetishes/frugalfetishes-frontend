...
// IMPORTANT: point admin dashboard to your backend API (not the frontend domain)
...
async function jsonFetch(path, opts = {}){
    const url = String(path || "").startsWith("http") ? String(path) : (BACKEND_BASE_URL.replace(/\/$/,"") + String(path));
